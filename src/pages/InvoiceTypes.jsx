...
function InvoiceTypes() {
  ...
  const invoiceTypes = [
    ...
    {
      name: t("partialInvoice"),
      description: t("partialInvoiceDesc"),
      type: "partial",
      features: [
        t("partialPaymentSupport"),
        t("paymentTracking"),
        t("remainingBalance"),
      ],
    },
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-3 sm:px-4 md:px-6 lg:px-8"
      dir={isRTL ? "rtl" : "ltr"}
    >
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-r ${
                  isRTL
                    ? "from-primary-700/10 to-primary-500/10"
                    : "from-primary-500/10 to-primary-700/10"
